...
import {
  LayoutDashboard, ClipboardList, User, Bell, Award, Leaf, X,
} from 'lucide-react';
...
const links = [
  ...
  { to: '/volunteer/impact', icon: Award, label: 'Impact' },
  { to: '/volunteer/notifications', icon: Bell, label: 'Notifications' },
];

export default function VolunteerSidebar({ open = false, onClose = () => {} }) {
        ...
        <div className="px-6 py-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 font-medium">Volunteer Portal</p>
            </div>
